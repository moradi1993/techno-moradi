...
class UserInfoForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ('phone','address1','address2','city','stat','zipcode','country')
    ...
    new_password1= forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                ...
                'name':'password', 
                'type': 'password',
                'placeholder':'رمز بالای 8 کاراکتر شامل حروف و عدد وارد کنید'
            }
        )
    )
    ...
    new_password2 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                ...
                'name':'password',
                'type': 'password',
                'placeholder':'مجددا رمز خود را وارد کنید'
            }
        )
    )
    ...
    password1= forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                ...
                'name':'password', 
                'type': 'password',
                'placeholder':'رمز بالای 8 کاراکتر(شامل عدد و حروف) را وارد کنید'
            }
        )
    )
